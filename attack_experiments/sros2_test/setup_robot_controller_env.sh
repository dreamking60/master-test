#!/bin/bash
# Auto-generated SROS2 environment for robot_controller
# Source this file: source setup_robot_controller_env.sh

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
NODE_DIR="$SCRIPT_DIR/keys/robot_controller"
...
echo "SROS2 security enabled for: robot_controller"
